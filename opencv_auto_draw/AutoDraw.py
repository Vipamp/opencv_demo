'''
   @author: HeQingsong
   @date: 2022-02-15 13:43
   @filename: AutoDrwa.py
   @project: opencv_demo
...
if __name__ == '__main__':
    ...
    out = pool.map_async(mainCalculation, range(start_num, end_num + 1))
    division = 50
    while True:
        percentage = prjCur.value / prjNum
        nump = round(percentage * division)
        print("[{}{}] {:.0%}".format("=" * nump, " " * (division - nump), percentage))
